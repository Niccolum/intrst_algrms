...
@memprof(threshold=1024, plot=True)
def datalist_1_000_knapsack_6_solution() -> list:
    func = knapsack_6_solution
    start = 1_000
    return list(abstract_wrapper(func=func, start=start))
...
@memprof(threshold=1024, plot=True)
def datalist_2_000_knapsack_6_solution() -> list:
    func = knapsack_6_solution
    start = 2_000
    return list(abstract_wrapper(func=func, start=start))
...
datalist_1_000_knapsack_6_solution()
datalist_2_000_knapsack_6_solution()
