...
@memprof(threshold=1024, plot=True)
def datalist_100_bisect_node_class() -> list:
    from funcs import BisectNodeClass
    from data import datalist_100
    return abstract_wrapper(instance=BisectNodeClass(), datalist=datalist_100)


@memprof(threshold=1024, plot=True)
def datalist_1000_bisect_node_class() -> list:
    from funcs import BisectNodeClass
    from data import datalist_1000
    return abstract_wrapper(instance=BisectNodeClass(), datalist=datalist_1000)


@memprof(threshold=1024, plot=True)
def datalist_10000_bisect_node_class() -> list:
    from funcs import BisectNodeClass
    from data import datalist_10000
    return abstract_wrapper(instance=BisectNodeClass(), datalist=datalist_10000)


@memprof(threshold=1024, plot=True)
def datalist_100000_bisect_node_class() -> list:
    from funcs import BisectNodeClass
    from data import datalist_100000
    return abstract_wrapper(instance=BisectNodeClass(), datalist=datalist_100000)


@memprof(threshold=1024, plot=True)
def datalist_1000000_bisect_node_class() -> list:
    from funcs import BisectNodeClass
    from data import datalist_1000000
    return abstract_wrapper(instance=BisectNodeClass(), datalist=datalist_1000000)


datalist_100_bisect_node_class()
datalist_1000_bisect_node_class()
datalist_10000_bisect_node_class()
datalist_100000_bisect_node_class()
datalist_1000000_bisect_node_class()
